...
Con esto hacer al user 

GET http://localhost:3001/getionopiniones/v1/usuario
...
Con esto puede hacer al publication 

GET http://localhost:3001/getionopiniones/v1/publicacion
